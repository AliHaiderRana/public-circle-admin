...
export default function SesHealthHeaderAlert() {
  ...
  if (pathname.startsWith(SES_HEALTH_HREF)) return null;
  ...
  return (
    <Link
      ...
      className={cn(
        'flex min-w-0 max-w-xl flex-1 items-center gap-2 rounded-md border px-3 py-1.5 text-xs font-medium transition-colors',
        isCritical
    ...
    >
      ...
      <span className="truncate">{health.title}</span>
