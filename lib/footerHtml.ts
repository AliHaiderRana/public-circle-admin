const PUBLIC_CIRCLES_LOGO_URL =
  'https://publiccircles.s3.ca-central-1.amazonaws.com/public-circle-assets/PCLogoWhitetext.png';
const FOOTER_LOGO_WIDTH = 173;
...
export function generateFooterHtml(
  ...
  const poweredByInline = showPoweredBy
    ? `<span style="display:inline-block; vertical-align:middle;"><span style="vertical-align:middle;">Powered by</span><a href="https://publiccircles.com" target="_blank" style="display:inline-block; vertical-align:middle; text-decoration:none; margin-left:6px;"><img src="${PUBLIC_CIRCLES_LOGO_URL}" alt="Public Circles" width="${FOOTER_LOGO_WIDTH}" height="${FOOTER_LOGO_HEIGHT}" style="width:${FOOTER_LOGO_WIDTH}px !important; min-width:${FOOTER_LOGO_WIDTH}px !important; max-width:${FOOTER_LOGO_WIDTH}px !important; height:${FOOTER_LOGO_HEIGHT}px !important; min-height:${FOOTER_LOGO_HEIGHT}px !important; max-height:${FOOTER_LOGO_HEIGHT}px !important; border:0; display:inline-block; vertical-align:middle; -ms-interpolation-mode:bicubic;"></a></span>`
    : '';
  ...
  const desktopInnerTable = `<table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto; border-collapse:collapse; width:auto;"><tr>${showPoweredBy ? `<td valign="middle" style="padding:0; vertical-align:middle !important; color:#ffffff; font-family:'Cabin', Arial, sans-serif; font-size:14px; line-height:1.4; white-space:nowrap;">Powered by</td><td valign="middle" style="padding:0 0 0 6px; vertical-align:middle !important; line-height:0;"><a href="https://publiccircles.com" target="_blank" style="display:inline-block; text-decoration:none; vertical-align:middle;"><img src="${PUBLIC_CIRCLES_LOGO_URL}" alt="Public Circles" width="${FOOTER_LOGO_WIDTH}" height="${FOOTER_LOGO_HEIGHT}" style="width:${FOOTER_LOGO_WIDTH}px !important; min-width:${FOOTER_LOGO_WIDTH}px !important; max-width:${FOOTER_LOGO_WIDTH}px !important; height:${FOOTER_LOGO_HEIGHT}px !important; min-height:${FOOTER_LOGO_HEIGHT}px !important; max-height:${FOOTER_LOGO_HEIGHT}px !important; border:0; display:block; -ms-interpolation-mode:bicubic;"></a></td>` : ''}${showPoweredBy && includeUnSubscriber ? `<td valign="middle" style="padding:0 10px; vertical-align:middle !important;"><span style="display:inline-block; width:4px; height:4px; background-color:#ffffff; border-radius:2px; vertical-align:middle;"></span></td>` : ''}${includeUnSubscriber ? `<td valign="middle" style="padding:0; vertical-align:middle !important; color:#ffffff; font-family:'Cabin', Arial, sans-serif; font-size:14px; line-height:1.4; white-space:nowrap;"><a href="{{unsubscribe}}" style="color:#ffffff; text-decoration:underline;">Unsubscribe</a><span style="color:#ffffff;"> from Emails</span></td>` : ''}</tr></table>`;
