...
const FOOTER_LOGO_HEIGHT = 38;
const FOOTER_LOGO_IMG_STYLE = `width:${FOOTER_LOGO_WIDTH}px !important; max-width:${FOOTER_LOGO_WIDTH}px !important; height:auto !important; max-height:${FOOTER_LOGO_HEIGHT}px !important; border:0; display:inline-block; vertical-align:middle; -ms-interpolation-mode:bicubic;`;
