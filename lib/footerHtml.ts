const PUBLIC_CIRCLES_LOGO_URL =
  'https://publiccircles.s3.ca-central-1.amazonaws.com/PCLogoWhitetext.png?v=1930';
const FOOTER_LOGO_HEIGHT = 40;
const FOOTER_LOGO_WIDTH = 174;
const FOOTER_LOGO_IMG_STYLE = `height:${FOOTER_LOGO_HEIGHT}px !important; width:auto !important; max-height:${FOOTER_LOGO_HEIGHT}px !important; border:0; display:inline-block !important; vertical-align:middle; -ms-interpolation-mode:bicubic;`;
