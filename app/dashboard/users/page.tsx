    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-neutral-500">Manage administrative and platform users across all companies.</p>
        </div>
      </div>
              ...
              {loading ? (
                ...
                users.map((user) => (
                  <TableRow key={user._id}>
                    ...
                    <TableCell>
                      <Badge className={`text-[10px] ${user.status === 'ACTIVE' ? 'bg-neutral-900 text-white' : ''}`} variant={user.status === 'ACTIVE' ? 'default' : 'destructive'}>
                        {user.status}
                      </Badge>
                    </TableCell>
